        ...
        <div class="container section-container--narrow">
            <div class="section-content-shell section-content-shell--narrow">
              <div class="about-grid">
                ...
                <div class="about-card glass-panel"><h3 class="about-info-title">{{ copy.aboutTitle }}</h3><p class="about-text">{{ copy.aboutParagraphOne }}</p><div class="about-experience"><h3 class="about-experience-title">{{ copy.experienceTitle }}</h3><ExperienceTimeline :experiences="localizedPortfolio.experiences" :heading-level="4" /></div><div class="about-stats"><div class="stat-item"><span class="stat-num">2</span><span class="stat-label">{{ copy.years }}</span></div><div class="stat-item"><span class="stat-num">{{ localizedPortfolio.projects.length }}</span><span class="stat-label">{{ copy.projects }}</span></div><div class="stat-item"><span class="stat-num">C1</span><span class="stat-label">{{ copy.english }}</span></div></div></div>
  ...
  if(!reducedMotion){
    introContext=gsap.context(()=>{
      ...
      intro
        ...
        .from('.hero-tag',{y:18,autoAlpha:0,duration:.55},'-=.35')
...
@media(max-width:768px){
  ...
  .hero-tag{margin-bottom:1rem;font-size:.72rem;transform:none}
